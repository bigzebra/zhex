# This Makefile is for the ZHex extension to perl.
#
...
# These definitions are from config.sh (via C:/perl/strawberry-5.18.2.1/perl/lib/Config.pm).
...
FULL_AR = 
LD = g++.exe
LDDLFLAGS = -mdll -s -L"C:\perl\strawberry-5.18.2.1\perl\lib\CORE" -L"C:\perl\strawberry-5.18.2.1\c\lib"
LDFLAGS = -s -L"C:\perl\strawberry-5.18.2.1\perl\lib\CORE" -L"C:\perl\strawberry-5.18.2.1\c\lib"
LIBC = 
LIB_EXT = .a
OBJ_EXT = .o
OSNAME = MSWin32
OSVERS = 6.2
RANLIB = rem
SITELIBEXP = C:\perl\strawberry-5.18.2.1\perl\site\lib
SITEARCHEXP = C:\perl\strawberry-5.18.2.1\perl\site\lib
SO = dll
VENDORARCHEXP = C:\perl\strawberry-5.18.2.1\perl\vendor\lib
VENDORLIBEXP = C:\perl\strawberry-5.18.2.1\perl\vendor\lib
...
MAN3EXT = 3
INSTALLDIRS = site
INSTALL_BASE = C:/Users/Zeebruh/perl5
DESTDIR = 
PREFIX = $(INSTALL_BASE)
...
INSTALLARCHLIB = $(INSTALL_BASE)\lib\perl5\MSWin32-x86-multi-thread-64int
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = $(INSTALL_BASE)\lib\perl5\MSWin32-x86-multi-thread-64int
DESTINSTALLSITEARCH = $(DESTDIR)$(INSTALLSITEARCH)
INSTALLVENDORARCH = $(INSTALL_BASE)\lib\perl5\MSWin32-x86-multi-thread-64int
...
PERL_LIB = C:\perl\strawberry-5.18.2.1\perl\lib
PERL_ARCHLIB = C:\perl\strawberry-5.18.2.1\perl\lib
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = C:\perl\strawberry-5.18.2.1\perl\lib\CORE
PERL = C:\perl\strawberry-5.18.2.1\perl\bin\perl.exe
FULLPERL = C:\perl\strawberry-5.18.2.1\perl\bin\perl.exe
ABSPERL = $(PERL)
PERLRUN = $(PERL)
...
MAKEMAKER   = C:/Users/Zeebruh/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.92
MM_REVISION = 69200
...
PM_TO_BLIB = lib/ZHex.pm \
	...
	lib/ZHex/Cursor.pm \
	blib\lib\ZHex\Cursor.pm \
	lib/ZHex/Debug.pm \
	blib\lib\ZHex\Debug.pm \
	lib/ZHex/Display.pm \
	blib\lib\ZHex\Display.pm \
	lib/ZHex/Editor.pm \
...
ZHex.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"ZHex\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "generated_by: 'ExtUtils::MakeMaker version 6.92, CPAN::Meta::Converter version 2.140640'" >> META_new.yml
	$(NOECHO) $(ECHO) "license: unknown" >> META_new.yml
	$(NOECHO) $(ECHO) meta-spec: >> META_new.yml
	$(NOECHO) $(ECHO) "  url: http://module-build.sourceforge.net/META-spec-v1.4.html" >> META_new.yml
	$(NOECHO) $(ECHO) "  version: '1.4'" >> META_new.yml
	$(NOECHO) $(ECHO) "name: ZHex" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "   \"generated_by\" : \"ExtUtils::MakeMaker version 6.92, CPAN::Meta::Converter version 2.140640\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"ZHex\"," >> META_new.json
